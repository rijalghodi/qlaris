        ...
        >
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5">
              <span className="text-2xl font-bold text-primary">{BRAND.APP_NAME}</span>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4 py-12 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-block">
                <span className="text-2xl font-bold text-primary">{BRAND.SITE_NAME}</span>
              </Link>
              <p className="mt-4 text-sm text-muted-foreground max-w-sm">
                Simple POS for everyday selling. Designed for Indonesian small businesses to manage
          ...
          <div className="mt-8 border-t pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} {BRAND.SITE_NAME}. All rights reserved.
            </p>
