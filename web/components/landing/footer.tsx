...
export function FooterSection({
  ...
  copyright = "©2026 Rijal Ghodi. All rights reserved",
  policies = [
  ...
  return (
    <footer className={cn("bg-background w-full px-4", className)}>
      <div className="max-w-shell mx-auto">
        <Footer>
          <FooterContent>
            <FooterColumn className="col-span-12 sm:col-span-6 md:col-span-6">
            ...
            {columns.map((column, index) => (
              <FooterColumn key={index} className="col-span-12 sm:col-span-4 md:col-span-2">
