...
type User struct {
	...
	RequestVerificationAt  *time.Time `gorm:"not null;default:now()" json:"request_verification_at"`
	RequestResetPasswordAt *time.Time `gorm:"not null;default:now()" json:"request_reset_password_at"`
